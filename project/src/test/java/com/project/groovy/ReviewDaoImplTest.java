...
//	@Test
	public void testSelectAll() throws Exception {
		Review review = new Review(album_id, "asdf", "狼利", "comment1", 0);
		assertTrue(reviewDao.insert(review) == 1);
		
		List<Review> list = reviewDao.selectAll(album_id);
		assertTrue(list.size() == 1);
		
		Review review2 = new Review(album_id, "asdf", "狼利", "comment2", 0);
...
//	@Test
	public void testSelectRate() throws Exception {
		Review review = new Review(album_id, "asdf", "狼利", "comment1", 1);
		assertTrue(reviewDao.insert(review) == 1);
		
		Review review2 = new Review(album_id, "asdf", "狼利", "comment2", 2);
		assertTrue(reviewDao.insert(review2) == 1);
...
//	@Test
	public void testSelectLike() throws Exception {
		...
		Review review2 = new Review(album_id, "asdf", "狼利", "comment1", 0);
		assertTrue(reviewDao.insert(review2) == 1);
...
//	@Test
	public void testInsert() throws Exception {
		Review review = new Review(album_id, "asdf", "狼利", "comment", 0);
		assertTrue(reviewDao.insert(review) == 1);
...
//	@Test
	public void testSelectPage() throws Exception {
		for (int i=1; i<=20; i++) {
			Review review = new Review(album_id, "asdf", "狼利", "comment" + i, 0);
			assertTrue(reviewDao.insert(review) == 1);
		}
